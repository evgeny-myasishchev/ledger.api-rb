...
RSpec.describe 'V2::AccountCategories', type: :request do
  include JsonApiSerialize
  include AuthHelpers
  include MatchingLedgerHelpers

  describe 'GET /v2/ledgers/:ledger_id/accounts-categories' do
    it_behaves_like 'authorized action', :get,
                    path: { helper: :v2_ledger_account_categories_path, ledger_id: 'fake' },
    ...
    it 'should return account-categories' do
      ...
      get v2_ledger_account_categories_path(ledger_id: ledger.id), with_valid_auth_header(scope: 'read:account-categories', sub: ledger_user.user_id)
  ...
  describe 'POST /v2/ledgers/:ledger_id/accounts-categories' do
    ...
    it 'should fail with 404 if ledger is not shared with user' do
      ...
      post v2_ledger_account_categories_path(ledger_id: account_category.ledger_id),
