...
RSpec.describe 'V1::Tags', type: :request do
  ...
  describe 'GET /v1/ledgers/:ledger_id/tags' do
    it_behaves_like 'authorized action', :get,
                    path: { helper: :v1_ledger_tags_path, ledger_id: 'fake' },
    ...
    it 'should return tags' do
      ...
      get v1_ledger_tags_path(ledger_id: ledger.id), with_valid_auth_header(scope: 'read:tags', sub: ledger_user.user_id)
  ...
  describe 'POST /v1/ledgers/:ledger_id/tags' do
    ...
    it 'should fail with 404 if ledger is not shared with user' do
      ...
      post v1_ledger_tags_path(ledger_id: tag.ledger_id),
